 ...
 * particular supplier — an MCP server's name, "pi", "Toad".
 */
...
export type DeskCapabilities = {
	 ...
	 * that would have worked, giving a reason that is a lie. Absent means "too
	 * old to say", which is a different sentence from "has none". Desks on
	 * 0.4.0 and 0.4.1 also advertise a `plugins` array here; the field is gone
	 * and the rebuild drops it, which is the whole point of rebuilding.
	 */
	format?: number;
